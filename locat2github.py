...
import os
import argparse
## 原作者：https://www.jianshu.com/p/3e1c2b25732e
# 线上线下图床位置已经确定不变
path_offline = r"D:\myblog\github_picture\mypicture\imgs" + '\\' # 本地图床目录
path_online = "https://github.com/Dioxideme/mypicture/blob/maste/imgs/" # 线上图床目录
